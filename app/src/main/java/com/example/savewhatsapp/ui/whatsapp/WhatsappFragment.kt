...
import com.example.statussaverapplication.adapters.fragments.WhatsappViewPagerAdapter
...
import com.savewhatsapp.databinding.FragmentWhatsappBinding

class WhatsappFragment : Fragment(), PopupMenu.OnMenuItemClickListener {
    ...
    private fun setupViewPager(){
        val adapter = WhatsappViewPagerAdapter(requireActivity(), 2)
